        ...
        for o=1:5%BeaconRange
            ...
            FalseNegativeRate=zeros(1,RunTimes);
                for r=1:RunTimes
                       ...
                       %FalseNegativeRate(r)=FalseNegativeNum(r)/SpoofedCountArray(r);
                       FalseNegativeRate(r)=FalseNegativeNum(r)/(SUNumber- NumInitialAnchors);
                        filename=['FalseNegativeResult_SUNUmber_',num2str(SUNumber),'_SpoofRange_',num2str(SpoofRange),'_BeaconRange_',num2str(BeaconRange),'_InitialAnchorRatio_',num2str(InitialAnchorRatio),'.mat'];
                        save(filename,'FalseNegativeRate','FalseNegativeNum','SpoofedCountArray');
                end
        end
    end
end
